package com.honkai.blog.cache.impl;

import com.honkai.blog.cache.IGlobalCache;
...
public final class AppRedisCacheManager implements IGlobalCache {
    ...
    public long incr(String key, long delta) {
        ...
        return redisTemplate.opsForValue().increment(key, delta) != null ? 1 : 0;
    }
    ...
    public long sSet(String key, Object... values) {
        try {
            return redisTemplate.opsForSet().add(key, values) != null ? 1 : 0;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public long sGetSetSize(String key) {
        try {
            return redisTemplate.opsForSet().size(key) != null ? 1 : 0;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public long setRemove(String key, Object... values) {
        try {
            return redisTemplate.opsForSet().remove(key, values) != null ? 1 : 0;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public long lGetListSize(String key) {
        try {
            return redisTemplate.opsForList().size(key) != null ? 1 : 0;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public long lRemove(String key, long count, Object value) {
        try {
            return redisTemplate.opsForList().remove(key, count, value) != null ? 1 : 0;
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
